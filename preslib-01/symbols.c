...
int SY__BCNCAR01(int orient)
{
    ...
    PU(750, 780);
    PM(0);
    PD(552, 1052, 950, 1057, 750, 780, 0);
    PM(2);
    FP();
    PU(750, 445);
    PM(0);
    PD(952, 720, 555, 720, 750, 445, 0);
    PM(2);
    FP();
    SP(m);
    SW(1);
...
int SY__BCNCAR02(int orient)
{
    ...
    PU(750, 420);
    PM(0);
    PD(947, 695, 552, 692, 750, 420, 0);
    PM(2);
    FP();
    PU(585, 805);
    PM(0);
    PD(947, 805, 750, 1080, 552, 805, 0);
    PM(2);
    FP();
    SP(m);
    SW(1);
...
int SY__BCNCAR03(int orient)
{
    ...
    PU(585, 445);
    PM(0);
    PD(947, 447, 750, 720, 555, 445, 0);
    PM(2);
    FP();
    PU(585, 780);
    PM(0);
    PD(947, 780, 750, 1055, 552, 780, 0);
    PM(2);
    FP();
    SP(m);
    SW(1);
...
int SY__BCNCAR04(int orient)
{
    ...
    PU(750, 780);
    PM(0);
    PD(552, 1055, 947, 1055, 750, 780, 0);
    PM(2);
    FP();
    PU(585, 445);
    PM(0);
    PD(947, 445, 750, 720, 550, 445, 0);
    PM(2);
    FP();
    SP(m);
    SW(1);
...
int SY__BCNGEN01(int orient)
{
    ...
    PU(675, 743);
    PM(0);
    PD(675, 300, 818, 300, 818, 750, 809, 725, 806, 706, 800, 700, 778,
       690, 759, 684, 753, 681, 734, 684, 725, 684, 712, 690, 0);
    PD(703, 703, 693, 718, 681, 725, 675, 740, 675, 750, 0);
    PM(2);
    FP();
    PU(750, 750);
    SW(2);
...
int SY__BCNLAT15(int orient)
{
    ...
    PU(500, 1050);
    PM(0);
    PD(700, 1050, 700, 650, 500, 650, 500, 1050, 0);
    PM(2);
    FP();
    SP(m);
    SW(1);
...
int SY__BCNLAT16(int orient)
{
    ...
    PU(650, 950);
    PM(0);
    PD(850, 950, 850, 550, 650, 550, 650, 950, 0);
    PM(2);
    FP();
    SP(m);
    SW(1);
...
int SY__BOYCAR01(int orient)
{
    ...
    PU(778, 790);
    PM(0);
    PD(778, 1050, 484, 1053, 778, 790, 0);
    PM(2);
    FP();
    PU(593, 718);
    PM(0);
    PD(900, 718, 900, 437, 593, 718, 0);
    PM(2);
    FP();
    SP(m);
    SW(1);
...
int SY__BOYCAR02(int orient)
{
    ...
    PU(640, 695);
    PM(0);
    PD(950, 692, 947, 420, 640, 695, 0);
    PM(2);
    FP();
    PU(585, 805);
    PM(0);
    PD(890, 805, 585, 1080, 585, 805, 0);
    PM(2);
    FP();
    SP(m);
    SW(1);
...
int SY__BOYCAR03(int orient)
{
    ...
    PU(735, 445);
    PM(0);
    PD(1010, 445, 700, 715, 700, 445, 0);
    PM(2);
    FP();
    PU(625, 780);
    PM(0);
    PD(900, 780, 595, 1052, 595, 780, 0);
    PM(2);
    FP();
    SP(m);
    SW(1);
...
int SY__BOYCAR04(int orient)
{
    ...
    PU(750, 720);
    PM(0);
    PD(750, 445, 1050, 445, 750, 720, 0);
    PM(2);
    FP();
    PU(750, 780);
    PM(0);
    PD(750, 1055, 452, 1055, 750, 780, 0);
    PM(2);
    FP();
    SP(m);
    SW(1);
...
int SY__BOYSPR01(int orient)
{
    ...
    PU(690, 750);
    PM(0);
    PD(793, 318, 890, 318, 800, 709, 781, 703, 771, 696, 753, 693, 731,
       700, 687, 750, 715, 706, 706, 712, 690, 750, 0);
    PM(2);
    FP();
    PU(750, 750);
    SW(2);
...
int SY__BUISGL01(int orient)
{
    ...
    PU(618, 618);
    PM(0);
    PD(868, 618, 868, 868, 618, 868, 618, 618, 0);
    PM(2);
    FP();
    SP(W);
    SW(2);
...
int SY__CAIRNS01(int orient)
{
    ...
    PU(768, 312);
    PM(0);
    PD(809, 325, 834, 337, 859, 368, 868, 393, 875, 412, 875, 443, 862,
       468, 853, 487, 837, 509, 828, 518, 837, 493, 850, 468, 0);
    PD(853, 450, 853, 418, 843, 387, 834, 368, 818, 350, 793, 328, 768,
       312, 0);
    PM(2);
    FP();
    PU(675, 512);
    PM(0);
    PD(700, 534, 725, 553, 734, 568, 743, 593, 0);
    PD(750, 618, 750, 637, 737, 668, 728, 693, 712, 712, 684, 734, 700,
       709, 712, 684, 725, 634, 725, 609, 712, 578, 703, 559, 684, 528,
       675, 512, 0);
    PM(2);
    FP();
    PU(878, 525);
    PM(0);
    PD(903, 528, 928, 537, 953, 562, 962, 578, 975, 603, 978, 628, 975,
       653, 968, 675, 959, 693, 943, 709, 925, 734, 943, 700, 953, 668, 0);
    PD(959, 634, 950, 593, 934, 568, 912, 543, 893, 534, 878, 525, 0);
    PM(2);
    FP();
    PU(750, 750);
    SW(2);
...
int SY__CLRLIN01(int orient)
{
    ...
    PU(1337, 1500);
    PM(0);
    PD(1500, 893, 1662, 1500, 1337, 1500, 0);
    PM(2);
    FP();
    return 0;
}
...
int SY__DNGHILIT(int orient)
{
    ...
    PU(1206, 1206);
    PM(0);
    PD(1793, 1206, 1793, 1793, 1206, 1793, 1206, 1206, 0);
    PM(2);
    FP();
    SW(3);
    PU(1206, 1793);
...
int SY__FLASTK01(int orient)
{
    ...
    PU(1450, 1500);
    PM(0);
    PD(1450, 1175, 1550, 1175, 1550, 1500, 1537, 1462, 1500, 1450, 1468,
       1462, 1450, 1500, 0);
    PM(2);
    FP();
    PU(1500, 1500);
...
int SY__HULKES01(int orient)
{
    ...
    PU(500, 840);
    PM(0);
    PD(550, 856, 606, 865, 656, 875, 700, 875, 750, 859, 784, 856, 825,
       840, 859, 825, 884, 809, 925, 790, 950, 775, 965, 756, 0);
    PD(984, 750, 965, 725, 940, 700, 909, 684, 881, 665, 850, 650, 815,
       634, 790, 625, 753, 618, 715, 609, 681, 609, 656, 609, 625, 615,
       600, 615, 0);
    PD(565, 625, 540, 631, 525, 640, 500, 650, 500, 840, 500, 840, 0);
    PM(2);
    FP();
    SP(X);
    SW(2);
...
int SY__ISODGR01(int orient)
{
    ...
    PU(600, 350);
    PM(0);
    PD(850, 450, 950, 700, 850, 950, 600, 1050, 350, 950, 250, 700, 350,
       450, 600, 350, 600, 625, 737, 487, 812, 562, 0);
    PD(675, 700, 812, 837, 737, 912, 600, 775, 462, 912, 387, 837, 525,
       700, 387, 562, 462, 487, 600, 625, 600, 350, 0);
    PM(2);
    FP();
    SW(1);
    PU(250, 700);
...
int SY__LIGHTDEF(int orient)
{
    ...
    PU(1500, 1500);
    PM(0);
    PD(1375, 937, 1375, 912, 1381, 875, 1400, 843, 1418, 825, 1450, 800,
       1493, 800, 1531, 800, 1556, 806, 1593, 831, 0);
    PD(1606, 868, 1612, 900, 1612, 931, 1500, 1500, 0);
    PM(2);
    FP();
    SP(I);
    SW(1);
...
int SY__LIGHTS01(int orient)
{
    ...
    PU(750, 750);
    PM(0);
    PD(631, 190, 631, 165, 634, 131, 650, 96, 671, 75, 703, 56, 746, 50,
       787, 53, 812, 62, 846, 87, 862, 121, 868, 153, 0);
    PD(865, 184, 750, 750, 0);
    PM(2);
    FP();
    SW(1);
    PU(750, 750);
...
int SY__LIGHTS02(int orient)
{
    ...
    PU(2250, 2220);
    PM(0);
    PD(2130, 1657, 2130, 1635, 2130, 1597, 2145, 1560, 2167, 1545, 2197,
       1522, 2242, 1515, 2280, 1522, 2310, 1530, 0);
    PD(2340, 1552, 2355, 1590, 2362, 1620, 2362, 1650, 2250, 2220, 0);
    PM(2);
    FP();
    SP(q);
    SW(1);
...
int SY__LIGHTS03(int orient)
{
    ...
    PU(750, 750);
    PM(0);
    PD(628, 187, 628, 162, 631, 128, 650, 93, 668, 75, 700, 53, 743, 50,
       784, 50, 809, 59, 843, 84, 871, 131, 871, 178, 0);
    PD(871, 178, 750, 750, 0);
    PM(2);
    FP();
    SW(1);
    PU(750, 750);
...
int SY__PILBOP02(int orient)
{
    ...
    PU(603, 568);
    PM(0);
    PD(500, 837, 603, 1100, 712, 837, 603, 568, 0);
    PM(2);
    FP();
    PU(603, 837);
    SW(1);
...
int SY__PRDINS02(int orient)
{
    ...
    PU(665, 555);
    PM(0);
    PD(520, 700, 495, 675, 495, 565, 585, 475, 665, 555, 0);
    PM(2);
    FP();
    PU(830, 560);
    PM(0);
    PD(910, 475, 1000, 565, 1000, 670, 0);
    PD(970, 700, 830, 560, 0);
    PM(2);
    FP();
    SP(W);
    SW(2);
...
int SY__TOPMAR02(int orient)
{
    ...
    PU(1665, 785);
    PM(0);
    PD(1520, 950, 1730, 950, 1665, 785, 0);
    PM(2);
    FP();
    return 0;
}
...
int SY__TOPMAR04(int orient)
{
    ...
    PU(1560, 785);
    PM(0);
    PD(1780, 785, 1620, 940, 1560, 785, 0);
    PM(2);
    FP();
    return 0;
}
...
int SY__TOPMAR05(int orient)
{
    ...
    PU(1665, 770);
    PM(0);
    PD(1515, 950, 1750, 950, 1665, 770, 0);
    PM(2);
    FP();
    PU(1715, 545);
    PM(0);
    PD(1565, 730, 1790, 730, 1715, 545, 0);
    PM(2);
    FP();
    return 0;
}
...
int SY__TOPMAR06(int orient)
{
    ...
    PU(1555, 775);
    PM(0);
    PD(1790, 775, 1615, 935, 1555, 775, 0);
    PM(2);
    FP();
    PU(1600, 565);
    PM(0);
    PD(1835, 565, 1665, 725, 1600, 565, 0);
    PM(2);
    FP();
    return 0;
}
...
int SY__TOPMAR07(int orient)
{
    ...
    PU(1550, 785);
    PM(0);
    PD(1785, 785, 1615, 950, 1550, 785, 0);
    PM(2);
    FP();
    PU(1700, 555);
    PM(0);
    PD(1570, 730, 1790, 730, 1700, 555, 0);
    PM(2);
    FP();
    return 0;
}
...
int SY__TOPMAR08(int orient)
{
    ...
    PU(1665, 770);
    PM(0);
    PD(1510, 950, 1750, 950, 1665, 770, 0);
    PM(2);
    FP();
    PU(1595, 565);
    PM(0);
    PD(1840, 565, 1670, 730, 1595, 565, 0);
    PM(2);
    FP();
    return 0;
}
...
int SY__TOPMAR22(int orient)
{
    ...
    PU(1500, 745);
    PM(0);
    PD(1390, 920, 1610, 920, 1500, 745, 0);
    PM(2);
    FP();
    return 0;
}
...
int SY__TOPMAR24(int orient)
{
    ...
    PU(1390, 750);
    PM(0);
    PD(1610, 750, 1500, 920, 1390, 750, 0);
    PM(2);
    FP();
    return 0;
}
...
int SY__TOPMAR25(int orient)
{
    ...
    PU(1500, 525);
    PM(0);
    PD(1390, 700, 1610, 700, 1500, 525, 0);
    PM(2);
    FP();
    PU(1500, 745);
    PM(0);
...
int SY__TOPMAR26(int orient)
{
    ...
    PU(1390, 530);
    PM(0);
    PD(1610, 530, 1500, 700, 1390, 530, 0);
    PM(2);
    FP();
    return 0;
}
...
int SY__TSSLPT51(int orient)
{
    ...
    PU(1950, 1950);
    PM(0);
    PD(2250, 1500, 2550, 1950, 2400, 1950, 2400, 2850, 2100, 2850, 2100,
       1950, 1950, 1950, 0);
    PM(2);
    FP();
    SW(1);
...
int SY__WRECKS01(int orient)
{
    ...
    PU(550, 750);
    PM(0);
    PD(400, 550, 1050, 750, 800, 750, 800, 740, 795, 730, 790, 720, 780,
       710, 770, 700, 760, 700, 745, 700, 735, 700, 0);
    PD(720, 705, 705, 720, 700, 735, 700, 740, 700, 750, 550, 750, 550,
       750, 0);
    PM(2);
    FP();
    PU(750, 750);
...
int CS__SEABED01(void){
		...
		AC(DEPVS);
	}else if((attrib[DRVAL1] >= safety_contour)&&
